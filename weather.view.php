...
<div id="content" class="container">
  ...
  <div class="info-side">
    ...
    <div class="week-container">
      <ul class="week-list">
        <li class="active" onclick="location.href='weather.view.php'">
            <?php 
                $day -> set_weather_data(0);
                $icon = $day -> getWeather_Icon();
        ...
        <li onclick="location.href='other-days/weather2.view.php'">
            <?php 
        ...
        <li onclick="location.href='other-days/weather3.view.php'">
            <?php 
        ...
        <li onclick="location.href='other-days/weather4.view.php'">
            <?php 
        ...
        <li onclick="location.href='other-days/weather5.view.php'">
            <?php 
